...
public class Exercise_2 {
    ...
    private static class VProg extends AbstractFunction3<Long, Integer, Integer, Integer> implements Serializable {
        ...
        public Integer apply(Long vertexID, Integer vertexValue, Integer message) {
            if (message == Integer.MAX_VALUE) {
                ...
                Integer min = Math.min(vertexValue, message);
                return min;
            }
        }
    }
    ...
    private static class sendMsg
        ...
        public Iterator<Tuple2<Object, Integer>> apply(EdgeTriplet<Integer, Integer> triplet) {
            Integer srcAttr = triplet.srcAttr();
            Object srcId = triplet.srcId();
            Integer dstAttr = triplet.dstAttr();
            Object dstId = triplet.dstId();
            Integer edgeAttr = triplet.attr;
            Integer newAttr = srcAttr + edgeAttr;
            System.out
                    .print("Iteration: from node " + srcId + " value " + srcAttr + " to node " + dstId + " value "
                            + dstAttr + " is " + edgeAttr + "\n");
            if (srcAttr == Integer.MAX_VALUE || newAttr >= dstAttr) {
                // do nothing
                ...
                return JavaConverters
                        .asScalaIteratorConverter(
                                Arrays.asList(new Tuple2<Object, Integer>(triplet.dstId(), newAttr)).iterator())
                        .asScala();
            }
        }
    }
    ...
    public static void shortestPaths(JavaSparkContext ctx) {
        ...
        Graph<Integer, Integer> G = Graph.apply(verticesRDD.rdd(), edgesRDD.rdd(), 1, StorageLevel.MEMORY_ONLY(),
